...
def createPureGENCOLInputFileResources(fileName):
    myFile = open(fileName, 'a')
    myFile.write("Resources={\nTime Strong;\nAutonomy Strong;\n};\n\n")
    pass
...
def createPureGENCOLInputFileNodes(fileName, g, timeIntervals, droneAutonomy=25):
    myFile = open(fileName, 'a')
    myFile.write("Nodes={\n")
...
def createPureGENCOLInputFileArcs(fileName, g, serviceTime, droneSpeed=600, droneAutonomy=25):
...
def createCompleteGENCOLInputFileWithoutLegs(fileName, g, fixedCost, timeIntervals, serviceTime,
                                             droneSpeed=600, droneAutonomy=25):
    """Creates the comple GENCOL input file without generating the legs"""
    createGENCOLInputFile(fileName)
    createPureGENCOLInputFileResources(fileName)
    createGENCOLInputFileRows(fileName, g)
    createGENCOLInputFileTasks(fileName, g)
    createGENCOLInputFileColumns(fileName, fixedCost)
    createPureGENCOLInputFileNodes(fileName, g, timeIntervals, droneAutonomy)
    createPureGENCOLInputFileArcs(fileName, g, serviceTime, droneSpeed, droneAutonomy)
    createGENCOLInputFileNetwork(fileName, g)
    pass